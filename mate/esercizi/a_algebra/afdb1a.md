...
- trovo il resto dividendo per $(x - 1)$
  $P(1) = 1^3 - 6 \cdot 1^2 + 11 \cdot 1 - 6 = 1 - 6 + 11 - 6 = 0$
  $(x - 1)$ è un fattore
- trovo il resto dividendo per $(x + 1)$
  $P(-1) = (-1)^3 - 6 \cdot (-1)^2 + 11 \cdot (-1) - 6 = -1 - 6 - 11 - 6 \neq 0$
  $(x + 1)$ non è un fattore
- trovo il resto dividendo per $(x - 2)$
  $P(2) = 2^3 - 6 \cdot 2^2 + 11 \cdot 2 - 6 = 8 - 24 + 22 - 6 = 0$
  $(x - 2)$ è un fattore
- trovo il resto dividendo per $(x + 2)$
  $P(-2) = (-2)^3 - 6 \cdot (-2)^2 + 11 \cdot (-2) - 6 = -8 - 24 - 22 - 6 \neq 0$
  $(x + 2)$ non è un fattore
- trovo il resto dividendo per $(x - 3)$
  $P(3) = 3^3 - 6 \cdot 3^2 + 11 \cdot 3 - 6 = 27 - 54 + 33 - 6 = 0$
  $(x - 3)$ è un fattore
