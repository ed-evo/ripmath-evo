...
$$
\sqrt{5x + 10} = \sqrt{4 - x^2}
$$

Elevo a quadrato da una parte e dall'altra

$$
[\sqrt{5x + 10}]^2 = [\sqrt{4 - x^2}]^2
$$
...
$$
x_{1,2} = \frac{-5 \pm \sqrt{5^2 - 4 \cdot 1 \cdot 6}}{2}
$$
...
> **<span class="text-purple-700">Verifica per $x = -2$:</span>**
> Sostituisco nell'equazione iniziale alla $x$ il valore $-2$
> $$
> \sqrt{[5 \cdot (-2) + 10]} - \sqrt{[4 - (-2)^2]} = 0
> $$
> $$
> \sqrt{0} - \sqrt{0} = 0
> $$
...
> **<span class="text-purple-700">Verifica per $x = -3$:</span>**
> Sostituisco nell'equazione iniziale alla $x$ il valore $-3$
> $$
> \sqrt{[5 \cdot (-3) + 10]} - \sqrt{[4 - (-3)^2]} = 0
> $$
> $$
> \sqrt{-5} - \sqrt{-5} = 0
> $$
...
<span class="text-red-600">**Soluzione $x = -2$**</span>