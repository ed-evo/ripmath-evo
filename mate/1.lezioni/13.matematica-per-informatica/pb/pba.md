...
$$
$$
5 \text{ dita} = 1 \text{ mano}
$$
$$
1 \text{ mano} + 1 \text{ dito}
$$
$$
1 \text{ mano} + 2 \text{ dita}
$$

...

E che succede se il numero è veramente grande? Semplicemente basterà fare un gruppo fra i gruppi potendo così continuare all'infinito:
