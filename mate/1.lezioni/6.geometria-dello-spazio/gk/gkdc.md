...
questo sarà anche il volume del tronco di cono.
...
$$
V_{tronco} = \frac{h}{3} (\pi R^2 + \sqrt{\pi R^2 \cdot \pi r^2} + \pi r^2)
$$

$$
V_{tronco} = \frac{h}{3} (\pi R^2 + \sqrt{\pi^2 R^2 r^2} + \pi r^2)
$$

Posso estrarre la radice ed ottengo:
...
>
> $$
> \text{Volume} = \frac{\pi h}{3} (R^2 + Rr + r^2)
> $$
