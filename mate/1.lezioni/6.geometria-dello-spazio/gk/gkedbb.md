# [Area della superficie della calotta sferica]{.text-red-darken-1}
...
$$
A_{\text{calotta sferica}} = 2 \pi r h
$$
...
Da notare anche che, utilizzando il teorema di Pitagora, è possibile scrivere una relazione fra:
...
> L'arco con corda $$c$$ è l'arco generatore perché facendogli fare un giro completo attorno ad $$h$$ ottengo la calotta sferica

[approfondire?]{.text-red}