...
$$
\textcolor{red}{y = \frac{\sqrt{x}}{e^x}}
$$

Il campo di esistenza per la funzione è individuato dal fatto di esservi tra le funzioni la radice, quindi dovrà essere

$$
\textcolor{red}{\text{C.E. } \{x \in \mathbb{R} : x \ge 0\}}
$$
...
In rosso la loro funzione quoziente.