...
$$
\textcolor{red}{Q(x) = \{ x : x \text{ è immortale} \}}
$$

considero la negazione della seconda

$$
\textcolor{red}{\overline{Q(x)} = \{ x : x \text{ non è immortale} \}}
$$
...
> Come avrai notato la negazione di una proposizione corrisponde al complementare dell'insieme collegato