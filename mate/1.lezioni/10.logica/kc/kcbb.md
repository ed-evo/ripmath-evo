...
Neghiamo la frase: abbiamo visto che per negare non possiamo dire "nessun uomo è mortale" ma dobbiamo aggiungere un "non" alla frase precedente:

**Non tutti gli uomini sono mortali**

e può essere trasformata nella frase equivalente:

**Esiste qualche uomo che non è mortale**
