...
$$
\textcolor{blue}{4 \operatorname{sen}^2 x \cos^2 x = 1}
$$
...
$$
\textcolor{red}{(2 \operatorname{sen} x \cos x + 1)(2 \operatorname{sen} x \cos x - 1) = 0}
$$
...
- risolvo la prima
  ...
  ordino
  $$
  \textcolor{red}{\operatorname{tang}^2 x + 2 \operatorname{tang} x + 1 = 0}
  $$
  osservo che si tratta di un quadrato di binomio
  > **Nota:** se non te ne accorgi devi risolvere l'equazione
  $$
  \textcolor{red}{(\operatorname{tang} x + 1)^2 = 0}
  $$
  $$
  \textcolor{red}{\operatorname{tang} x + 1 = 0}
  $$
  $$
...
$$
\textcolor{blue}{x = 45^\circ + k 90^\circ}
$$