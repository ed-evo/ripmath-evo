...
$$
\textcolor{red}{x - 3 \geq \sqrt{x^2 - 3x + 2}}
$$
...
$$
\begin{cases} \textcolor{blue}{x^2 - 3x + 2 \geq 0} \\ \textcolor{blue}{x - 3 \geq 0} \\ \textcolor{blue}{(x-3)^2 \geq x^2 - 3x + 2} \end{cases}
$$
...
Devo prendere i valori che risolvono contemporaneamente tutte e tre le disequazioni: siccome non esistono valori comuni la mia disequazione [non ha soluzioni]{.text-blue}