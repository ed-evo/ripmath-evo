...
1 & -2 & 1 & 1 \\
3 & 2 & 0 & -1 \\
\textcolor{blue}{1} & \textcolor{blue}{0} & \textcolor{blue}{-2} & \textcolor{blue}{0}
\end{vmatrix}
$$
...
1 & -2 & 1 & 1 \\
3 & 2 & 0 & -1 \\
\textcolor{blue}{1} & 0 & \textcolor{blue}{-2} & 0
\end{vmatrix} = \textcolor{red}{-(1)} \cdot \begin{vmatrix}
1 & 1 & -1 \\
-2 & 1 & 1 \\
2 & 0 & -1
\end{vmatrix} - \textcolor{red}{(\textcolor{blue}{-2})} \cdot \begin{vmatrix}
0 & 1 & -1 \\
1 & -2 & 1 \\
3 & 2 & -1
\end{vmatrix} =
...
-2 & 1 & 1 \\
2 & 0 & -1
\end{vmatrix} \begin{matrix} 1 & 1 \\ -2 & 1 \\ 2 & 0 \end{matrix}
$$
...
2 & 0 & \textcolor{fuchsia}{-1}
\end{vmatrix} \begin{matrix} 1 & 1 \\ \textcolor{blue}{-2} & 1 \\ \textcolor{red}{2} & \textcolor{blue}{0} \end{matrix} = \textcolor{fuchsia}{1 \cdot 1 \cdot (-1)} + \textcolor{red}{1 \cdot 1 \cdot 2} + \textcolor{blue}{(-1) \cdot (-2) \cdot 0} = -1 + 2 = 1
$$
...
\textcolor{orange}{2} & \textcolor{green}{0} & \textcolor{purple}{-1}
\end{vmatrix} \begin{matrix} \textcolor{green}{1} & \textcolor{purple}{1} \\ \textcolor{purple}{-2} & 1 \\ 2 & 0 \end{matrix} = \textcolor{orange}{(-1) \cdot 1 \cdot 2} + \textcolor{green}{1 \cdot 1 \cdot 0} + \textcolor{purple}{1 \cdot (-2) \cdot (-1)} = -2 + 2 = 0
$$
...
1 & -2 & 1 \\
3 & 2 & -1
\end{vmatrix} \begin{matrix} 0 & -1 \\ 1 & -2 \\ 3 & 2 \end{matrix}
$$
...
$$
\begin{vmatrix}
\textcolor{fuchsia}{0} & \textcolor{red}{1} & \textcolor{blue}{-1} \\
1 & \textcolor{fuchsia}{-2} & \textcolor{red}{1} \\
3 & 2 & \textcolor{fuchsia}{-1}
\end{vmatrix} \begin{matrix} 0 & 1 \\ \textcolor{blue}{1} & -2 \\ \textcolor{red}{3} & \textcolor{blue}{2} \end{matrix} = \textcolor{fuchsia}{0 \cdot (-2) \cdot (-1)} + \textcolor{red}{1 \cdot 1 \cdot 3} + \textcolor{blue}{(-1) \cdot 1 \cdot 2} = 3 - 2 = 1
$$
...
\end{vmatrix} \begin{matrix} \textcolor{green}{0} & \textcolor{purple}{1} \\ \textcolor{purple}{1} & -2 \\ 3 & 2 \end{matrix} = \textcolor{orange}{(-1) \cdot (-2) \cdot 3} + \textcolor{green}{0 \cdot 1 \cdot 2} + \textcolor{purple}{1 \cdot 1 \cdot (-1)} = 6 - 1 = 5
$$
