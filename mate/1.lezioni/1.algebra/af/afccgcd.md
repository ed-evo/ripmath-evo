...
$$
\textcolor{blue}{x_{1,2} = \frac{-12 \pm \sqrt{12^2 - 4(1)(32)}}{2(1)} =}
$$

facciamo i calcoli dentro radice

$$
\textcolor{blue}{= \frac{-12 \pm \sqrt{144 - 128}}{2} =}
$$

$$
\textcolor{blue}{= \frac{-12 \pm \sqrt{16}}{2} =}
$$

$$
\textcolor{blue}{= \frac{-12 \pm 4}{2} =}
$$

adesso devo prendere una volta il più ed una volta il meno

$$
\textcolor{blue}{\frac{-12 + 4}{2} = \frac{-8}{2} = -4}
$$

$$
\textcolor{blue}{\frac{-12 - 4}{2} = \frac{-16}{2} = -8}
$$
...
$$
\textcolor{blue}{x_{1,2} = \frac{-6 \pm \sqrt{6^2 - (1)(32)}}{(1)} =}
$$
...
$$
\textcolor{blue}{-6 \pm \sqrt{4}}
$$

$$
\textcolor{blue}{= -6 \pm 2 =}
$$
