...
Eseguo i calcoli, prima dell'uguale il prodotto notevole e dopo l'uguale il prodotto:

$$
\textcolor{blue}{x^2 - a^2 + 2a^2 = ax + a^2}
$$

Conviene portare tutto prima dell'uguale:

$$
\textcolor{blue}{x^2 - a^2 + 2a^2 - ax - a^2 = 0}
$$
