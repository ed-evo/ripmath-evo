...
$$
\textcolor{red}{\frac{6x^2 - x\sqrt{3} - 6}{3x^2 + 4x\sqrt{3} - 12}}
$$
...
troviamo le radici delle equazioni associate ai polinomi della frazione
...
ho le soluzioni
$$
\textcolor{red}{x_1 = \frac{2\sqrt{3}}{3} \quad x_2 = -\frac{\sqrt{3}}{2}}
$$
...
$$
\textcolor{blue}{3x^2 + 4x\sqrt{3} - 12 = 0}
$$
ho le soluzioni
$$
\textcolor{red}{x_1 = -\frac{2\sqrt{3}}{3} \quad x_2 = 2\sqrt{3}}
$$
quindi posso scomporre come
$$
...
$$
\textcolor{red}{\frac{6x^2 - x\sqrt{3} - 6}{3x^2 + 4x\sqrt{3} - 12}} = \textcolor{red}{\frac{(3x - 2\sqrt{3})(2x + \sqrt{3})}{(3x - 2\sqrt{3})(x + 2\sqrt{3})}} = \textcolor{blue}{\frac{2x + \sqrt{3}}{x + 2\sqrt{3}}}
$$