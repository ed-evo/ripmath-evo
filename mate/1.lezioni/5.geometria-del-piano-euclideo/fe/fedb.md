...
1. Prendiamo per ipotesi che coincidano altezza e mediana
   > **Ipotesi:** $$AHB = AHC = \text{angolo retto}, BH = HC$$
   > **Tesi:** $$AB = AC$$

   > **Dimostrazione:** considero i triangoli $$ABH$$ ed $$AHC$$, essi hanno:
   > - gli angoli $$ABH = AHC$$ perché retti;
   > - $$BH = HC$$ per ipotesi;
   > - $$AH$$ in comune.
   >
...
2. Prendiamo per ipotesi che coincidano altezza e bisettrice
   > **Ipotesi:** $$AHB = AHC = \text{angolo retto}, \text{angoli } BAH = HAC$$
   > **Tesi:** $$AB = AC$$
...
3. Prendiamo per ipotesi che coincidano mediana e bisettrice
   > **Ipotesi:** $$BH = HC, \text{angoli } BAH = HAC$$
   > **Tesi:** $$AB = AC$$

   > **Dimostrazione:** opero un ribaltamento del lato $$AB$$ attorno alla retta $$AH$$: siccome gli angoli $$BHA$$ ed $$AHC$$ sono congruenti e sono congruenti anche i segmenti $$BH$$ e $$HC$$, il segmento $$AB$$ coinciderà esattamente con il segmento $$AC$$ ed il punto $$B$$ si trasferirà sul punto $$C$$ come volevamo.