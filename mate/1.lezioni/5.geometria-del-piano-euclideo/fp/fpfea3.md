...
Anche stavolta abbiamo due triangoli in cui uno è sovrapposto all'altro: se questo ti fa difficoltà puoi sempre pensare di staccare i due triangoli e poi procedere.
...
essi hanno:
$$\widehat{ACH} = \widehat{ACB}$$ perché angoli coincidenti
$$\widehat{AHC} = \widehat{BAC}$$ perché retti per ipotesi
...
> [$$A \quad H \quad C$$]{.text-red}
> [$$B \quad A \quad C$$]{.text-red}
