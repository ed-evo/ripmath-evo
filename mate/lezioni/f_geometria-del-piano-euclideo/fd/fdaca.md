...
$$
\textcolor{red}{\widehat{ABE} - \widehat{CBE} = \widehat{ABC}}
$$
...
> **Nota:** Da notare che per il teorema diretto è sufficiente usare il primo criterio; infatti quando studiavo io veniva trattato subito dopo il primo criterio di congruenza; poi si è preferito metterlo dopo il secondo criterio assieme al suo inverso in modo da formare quasi un unico teorema.