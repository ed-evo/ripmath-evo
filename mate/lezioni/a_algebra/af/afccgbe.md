...
$$
\frac{3}{x^2 - 3x + 2} - \frac{x - 2}{x - 1} + \frac{1}{2 - x} = 0
$$
...
> Devo moltiplicare da entrambe le parti per $(x - 1)(x - 2)$; posso farlo perché so che ogni termine è diverso da zero
...
$$
\begin{aligned}
\textcolor{blue}{-x} &= \textcolor{blue}{0} \\
\textcolor{blue}{x - 3} &= \textcolor{blue}{0}
\end{aligned}
$$
