...
che ha soluzioni [calcoli](afdgbac.html).
...
- Risolvo la prima: il minimo comune multiplo è $2x$ che è certamente [diverso da zero](afdgbaba.html):
...
che ha come soluzioni [calcoli](afdgbad.html).
...
che ha come soluzioni [calcoli](afdgbae.html).
