...
ricordando che
$x_1 + x_2 = -\frac{b}{a} = -\frac{-(k-2)}{k} = \frac{k-2}{k}$

$x_1 \cdot x_2 = \frac{c}{a} = \frac{1}{k}$

sostituendo ho l'equazione
$$
\frac{(k-2)^2}{k^2} - 2\frac{1}{k} = 5
$$

$$
\frac{(k-2)^2}{k^2} - \frac{2}{k} = 5
$$

m.c.m. $= k^2$ supponendo che $k$ sia diverso da zero
$$
\frac{(k-2)^2 - 2k}{k^2} = \frac{5k^2}{k^2}
$$
...
$$
k_{1,2} = \frac{-3 \pm \sqrt{3^2 - 4 \cdot 2 \cdot (-2)}}{4}
$$

$$
k_{1,2} = \frac{-3 \pm \sqrt{25}}{4} = \frac{-3 \pm 5}{4}
$$
