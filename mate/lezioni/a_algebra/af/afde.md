# <span class="text-red-600">Equazioni trinomie</span>
...
>
> $\textcolor{blue}{y_1 = -1}$ e $\textcolor{blue}{y_2 = -8}$ [calcoli](afde0.html)
>
...
- [Solo le soluzioni reali](afde1.html)
- [Sia le soluzioni reali che complesse](afde2.html)

Proviamo qualche esercizio:

$\textcolor{blue}{x^6 - 26x^3 - 27 = 0}$ [<span class="text-red-600">soluzione</span>](afde3.html)

$\textcolor{blue}{x^8 - 17x^4 + 16 = 0}$ [<span class="text-red-600">soluzione</span>](afde4.html)