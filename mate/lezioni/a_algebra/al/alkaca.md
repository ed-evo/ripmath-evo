...
$$
\begin{cases} \frac{x(2-x)}{3(2+x)} > 0 \\ \frac{x(2-x)}{3(2+x)} < 1 \end{cases}
$$
...
$$
\frac{x(2-x)}{3(2+x)} - 1 < 0
$$

ora posso fare il minimo comune multiplo prima dell'uguale:

$$
\frac{2x - x^2 - 3(2+x)}{3(2+x)} < 0
$$

$$
\frac{-x^2 + 2x - 6 - 3x}{3(2+x)} < 0
$$

$$
\frac{-x^2 - x - 6}{3(2+x)} < 0
$$
...
$$
\begin{cases} x < -2 \lor 0 < x < 2 \\ x > -2 \end{cases}
$$
