...
Facciamo un semplice esempio: considero una semplice equazione in algebra
...
$$
\textcolor{red}{x + 1''''' = 1'(x + 1')}
$$

Quindi costruiamo un "alfabeto" che ci permetta di sviluppare la teoria matematica (in questo caso l'algebra) utilizzando il minor numero di simboli possibile
