...
$$
\textcolor{red}{a^{m/n} = \sqrt[n]{a^m}}
$$

$$
\textcolor{red}{a^{-m/n} = \frac{1}{\sqrt[n]{a^m}}}
$$

Quindi possiamo rifarci a potenze con esponente intero

$$
(\sqrt{3})^{2/3} = \sqrt{3^{2/3}} = \sqrt{\sqrt[3]{3^2}} = \sqrt[6]{3^2} = \sqrt[3]{3}
$$