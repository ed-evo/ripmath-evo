...
Ciò ci porta a considerare l'esistenza di due operazioni di tipo moltiplicazione:
...
- una interna (numero complesso per numero complesso) che può trasformare il numero anche nella sua struttura trasformando in alcuni casi il risultato anche nella sola parte reale
$$
(3 + 4i) \cdot (2 - 3i) = 6 - 9i + 8i - 12i^2 = 6 - 9i + 8i + 12 = 18 - i
$$

> **Nota:** È un prodotto notevole:
> $$
