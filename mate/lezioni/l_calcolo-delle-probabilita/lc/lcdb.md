...
- **Problema 1**
  ...
  $$
  \textcolor{red}{p = \frac{2}{6} = \frac{1}{3} = 0,333333... = 0,3 \approx 33,33\%}
  $$

  > Ho usato il simbolo $\approx$ per indicare l'approssimazione.
  ...
  > $$
  > 0,3333 = \frac{33,33}{100} = 33,33\%
  > $$

- **Problema 2**
  Calcolare la probabilità, lanciando una moneta, di ottenere testa.

  Nel lancio di una moneta posso ottenere o testa o croce (suppongo che la moneta non possa restare appoggiata su un bordo).
  I casi favorevoli sono $1$;
  I casi possibili sono $2$ (le due facce della moneta), quindi:

  $$
  \textcolor{red}{p = \frac{1}{2} = 0,5 = 50\%}
  $$
...
- **Problema 3**
  ...
  $$
  \textcolor{red}{p = \frac{4}{20} = \frac{1}{5} = 0,2 = 20\%}
  $$
...
- **Problema 4**
  ...
  $$
  \textcolor{red}{p = \frac{4}{40} = \frac{1}{10} = 0,1 = 10\%}
  $$