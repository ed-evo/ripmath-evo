...
Intanto c'è da dire che il campo di esistenza per la funzione è individuato dal fatto di esservi tra le funzioni il logaritmo, quindi dovrà essere:

$$
\textcolor{red}{\text{C.E. } \{x \in \mathbb{R} : x > 0\}}
$$
