...
Il problema è tradurre un concetto così semplice in linguaggio matematico.

---

- [Limite finito di una funzione in un punto](cda.html)
- [Limite di una successione](cdb.html)
- [Limite destro e limite sinistro di una funzione in un punto](cdc.html)
- [Limite infinito](cdd.html)
- [Teoremi sui limiti](cde.html)
- [Limiti notevoli](cdf.html)
- [Forme indeterminate](cdg.html)