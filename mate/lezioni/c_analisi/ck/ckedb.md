...
$$
\textcolor{blue}{\int_{1}^{+\infty} \frac{1}{x^2} \, dx} =
$$
...
$$
\textcolor{blue}{= \lim_{a \to +\infty} -\frac{1}{a} - (-1) = 0 + 1 = 1}
$$

L'area compresa nella regione in questo caso è finita e vale un'unità quadrata del piano.