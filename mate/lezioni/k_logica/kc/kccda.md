...
$$
\textcolor{red}{Q(x) = \{ x : x \text{ ha 90 anni} \}}
$$

considero la negazione della seconda

$$
\textcolor{red}{\overline{Q(x)} = \{ x : x \text{ non ha 90 anni} \}}
$$
...
> **Nota:** In figura è in rosso la parte che ci interessa (gli uomini che non sono novantenni)