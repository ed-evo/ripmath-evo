# [successione dei numeri pari]{.text-red}
...
posso considerare di sommare ogni termine con sé stesso

$$
1+1, 2+2, 3+3, \dots, n+n, (n+1)+(n+1), \dots
$$
...
$$
2, 4, 6, \dots, n+n, (n+1)+(n+1), \dots
$$

ma è preferibile indicarla con

$$
2, 4, 6, \dots, 2n, 2n+2, \dots
$$

Possiamo anche farla iniziare da zero senza variare i termini dopo i puntini; tanto i puntini sono elastici e possono indicare indifferentemente quanti termini servono

$$
0, 2, 4, \dots, 2n, 2n+2, \dots
$$

od anche da un qualunque numero pari positivo
