...
> **Nota:** ti ricordo che per elevare una frazione a potenza negativa si può elevare l'inverso della frazione a potenza positiva e l'inverso di $$2$$ è $$\frac{1}{2}$$.

- Dal termine generico alla successione
  abbiamo il termine generico $$a_n = 2^{n-3}$$
  sostituiamo ad $$n$$ i valori $$1, 2, 3, 4, \dots$$
  sostituisco $$1$$: $$a_1 = 2^{1-3} = 2^{-2} = \left(\frac{1}{2}\