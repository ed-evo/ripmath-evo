...
$$
\textcolor{blue}{\text{PH} = \sin 0^\circ = 0}
$$

A novanta gradi avremo che il seno vale uno
$$
\textcolor{blue}{\text{PH} = \sin 90^\circ = \sin(\pi/2) = 1}
$$

A centoottanta gradi avremo che il seno vale zero
$$
\textcolor{blue}{\text{PH} = \sin 180^\circ = \sin \pi = 0}
$$

A duecentosettanta gradi avremo che il seno vale meno uno
$$
\textcolor{blue}{\text{PH} = \sin 270^\circ = \sin(3\pi/2) = -1}
$$

A trecentosessanta gradi è come a zero gradi ed avremo che il seno vale zero
$$
