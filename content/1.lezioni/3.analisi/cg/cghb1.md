...
Per trovare il massimo basterà trovare la derivata prima e porla uguale a zero:
...
Poiché vale la proprietà simmetrica posso leggere l'uguaglianza da destra a sinistra:
...
$$
[y\left(\frac{p}{2}\right) = p \cdot \frac{p}{2} - \left(\frac{p}{2}\right)^2]{.text-red}
$$

$$
[= \frac{p^2}{2} - \frac{p^2}{4} = \frac{p^2}{4}]{.text-red}
$$
