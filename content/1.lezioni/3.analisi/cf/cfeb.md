...
Data una funzione $$\textcolor{red}{y=f(x)}$$
continua in un intervallo chiuso e limitato $$\textcolor{red}{[a, b]}$$
e derivabile all'interno dell'intervallo allora esiste all'interno dell'intervallo un punto $$\textcolor{red}{c}$$ tale che:

$$
\textcolor{red}{f'(c) = \frac{f(b) - f(a)}{b - a}}
$$
