...
Comunque ora dobbiamo cercare di capire come funziona questo nuovo [giocattolo](cfd1.html) per poterlo poi utilizzare al meglio: vediamone quindi alcune proprietà.

- [Esempi di calcolo di qualche semplice derivata](cfda.html)
- [Tabella riassuntiva delle principali derivate](cfdb.html)
- [Semplici esercizi di applicazione della tabella](cfdc.html)
- [Operazioni sulle derivate](cfdd.html)
- [Tangente ad una curva in un punto](cfde.html)
- [Velocità ed accelerazione](cfdf.html)
- [Applicazioni alle forme indeterminate (De l'Hospital)](cfdg.html)