...
>
> $$
> \textcolor{red}{\lim_{x \to \infty} (x - \sqrt{x}) = \infty - \infty}
> $$
>
> $$
> \textcolor{red}{= \lim_{x \to \infty} \frac{(x - \sqrt{x})(x + \sqrt{x})}{x + \sqrt{x}}}
> $$
>
> Eseguiamo la moltiplicazione:
>
> $$
> \textcolor{red}{= \lim_{x \to \infty} \frac{x^2 - x}{x + \sqrt{x}}}
> $$
>
> È ora una frazione del tipo $$\infty / \infty$$ e applicando la regola degli ordini di infinito il numeratore ha ordine $$2$$ ed il denominatore $$1$$, quindi:
>
> $$
> \textcolor{red}{= \infty}
> $$