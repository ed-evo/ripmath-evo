...
| $[\text{v}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ |
| $[\text{v}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ |
...
| $[\text{v}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ |
| $[\text{v}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ | $[\text{f}]{\text{.text-red}}$ | $[\text{v}]{\text{.text-red}}$ |

Da notare che la sua negazione è la disgiunzione esclusiva

[se vuoi la pagina sulla coimplicazione](kbh.html)