...
$$
O meglio, siccome cerco le nuove coordinate rispetto alle vecchie:
$$
...
O meglio, siccome cerco le nuove coordinate rispetto alle vecchie:
$$
\textcolor{red}{Y} = y - \textcolor{blue}{b}
$$

Raccogliendo, le equazioni per la traslazione di coordinate saranno:
$$
\begin{cases}
\textcolor{blue}{X = x - a} \\
\textcolor{blue}{Y = y - b}
...
> **Nota:** Esercizi con queste formule, per essere significativi devono coinvolgere le coniche: sarebbe troppo semplice eseguire le traslazioni sulle rette; pertanto l'esercizio di esempio coinvolgerà una circonferenza.

Eseguire la traslazione di coordinate tale che la circonferenza
$$
\textcolor{blue}{x^2 + y^2 - 6x - 8y - 11 = 0}
$$
abbia il centro nell'origine degli assi. [soluzione](dcgaa.html)