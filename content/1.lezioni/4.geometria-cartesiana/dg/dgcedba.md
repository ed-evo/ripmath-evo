# Studio della parabola [$$y = 2x^2 - 2$$]{.text-blue}
...
x^2 = 1
$$
Otteniamo $$x_1 = -1$$ e $$x_2 = 1$$.
Quindi avremo i punti di intersezione di coordinate $$A \equiv (-1; 0)$$ e $$B \equiv (1; 0)$$.

3. **Troviamo l'equazione dell'asse verticale**
L'asse verticale ha la formula $$x = \frac{-b}{2a}$$ con $$b=0$$ ed $$a=2$$, quindi l'asse verticale ha equazione $$x=0$$ (è l'asse $$y$$).
...
$$
Abbiamo $$a=2$$, $$b=0$$ e $$c=-2$$, sostituendo abbiamo:
$$
V \equiv \left( \frac{-0}{2 \cdot 2}; -\frac{0^2 - 4 \cdot 2 \cdot (-2)}{4 \cdot 2} \right)
$$
$$
V \equiv (0; -2)
$$
