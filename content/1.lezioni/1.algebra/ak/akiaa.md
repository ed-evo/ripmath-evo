...
$$
\begin{cases}
\textcolor{blue}{x^2 - 16 \ge 0} \\
\textcolor{blue}{x - 2 > 0} \\
\textcolor{blue}{(x - 2)^2 > x^2 - 16}
\end{cases}
$$
...
Devo prendere i valori che risolvono contemporaneamente tutte e tre le disequazioni: ottengo come risultato

$$
\textcolor{blue}{4 \le x < 5}
$$