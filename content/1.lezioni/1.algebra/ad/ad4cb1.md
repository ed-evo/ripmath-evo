...
Per leggere la regola devi cominciare prima dell'uguale leggendo l'operazione che coinvolge tutti i termini ([il quadrato]{.text-purple}) poi devi dire fra chi è quest'operazione descrivendo il primo termine ([di un binomio]{.text-purple}).
...
> [Il quadrato di un binomio è uguale al quadrato del primo monomio più il doppio del prodotto del primo termine per il secondo, più il quadrato del secondo monomio]{.text-purple}