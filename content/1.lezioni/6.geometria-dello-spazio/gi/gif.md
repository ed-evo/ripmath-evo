...
[Se hai bisogno della dimostrazione](gifa.html)
...
$$
\frac{V_1}{V_2} \cdot \frac{V_2}{V_3} \cdot \frac{V_3}{1} = \frac{h}{1} \cdot \frac{b}{1} \cdot \frac{a}{1}
$$
