# [Volume del segmento sferico a due basi]{.text-red}

**Volume segmento sferico a due basi**

$$
V = \frac{1}{2} \pi h (r_1^2 + r_2^2) + \frac{1}{6} \pi h^3
$$

> Anche qui la dimostrazione è piuttosto complicata come calcoli e quindi la saltiamo.
>
