...
$$
V_{\text{spicchio}} = \frac{V_{\text{sfera}} \cdot \alpha^\circ}{360^\circ}
$$

quindi ricordando che il volume della sfera vale:
...
$$
V_{\text{spicchio}} = \frac{4}{3} \pi r^3 \cdot \frac{\alpha^\circ}{360^\circ}
$$

e, semplificando numeratore e denominatore, posso scrivere:

> **Volume dello spicchio sferico**
> $$
> \frac{\pi r^3 \alpha^\circ}{270^\circ}
> $$