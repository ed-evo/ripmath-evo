...
$$
\begin{aligned}
\textcolor{blue}{a} &= \textcolor{blue}{1} \\
\textcolor{blue}{b} &= \textcolor{blue}{a} \\
\textcolor{blue}{c} &= \textcolor{blue}{-a^2}
\end{aligned}
$$

$$
\textcolor{blue}{x_{1,2} = \frac{-a \pm \sqrt{a^2 - 4(1)(-a^2)}}{2}}
$$

$$
\textcolor{blue}{x_{1,2} = \frac{-a \pm \sqrt{a^2 + 4a^2}}{2}}
$$
...
Ora prendo una volta il meno ed una volta il più ed ho quindi le soluzioni
