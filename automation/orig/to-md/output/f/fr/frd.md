...
$$
\textcolor{red}{\text{Perimetro} = 2p = 4 \cdot 2r = 8r}
$$

L'esagono regolare inscritto in una circonferenza ha il lato congruente al raggio della circonferenza stessa.

Pertanto l'esagono avrà perimetro di misura:

$$
\textcolor{red}{\text{Perimetro} = 2p = 6 \cdot r = 6r}
$$

La circonferenza avrà una lunghezza che dipenderà dal suo diametro (se varia il diametro varia anche la circonferenza) chiamiamo tale lunghezza:

$$
\textcolor{red}{\text{Misura circonferenza} = \text{numero} \cdot 2r}
$$

e la misura della circonferenza sarà minore del perimetro del quadrato ma maggiore del perimetro dell'esagono:
