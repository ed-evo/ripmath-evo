...
Anche il terzo problema, che è quello che ci interessa, non è risolvibile con riga e compasso, ma useremo il metodo, già usato per introdurre i numeri reali, delle sezioni di Dedekind, utilizzando però delle classi contigue di misure di perimetri (per la circonferenza) e di aree (per il cerchio).