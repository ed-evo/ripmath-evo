...
- Gli angoli $$\textcolor{red}{AF}$$ congruenti perché in comune
- $$\textcolor{red}{BF = CF}$$ perché appena dimostrato

Quindi i due triangoli sono congruenti per il terzo criterio ed in particolare avranno congruenti gli angoli $$\textcolor{red}{BAF = CAF}$$, cioè $$\textcolor{red}{AF}$$ è la bisettrice come volevamo dimostrare.
