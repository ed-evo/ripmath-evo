...
$$
\textcolor{blue}{m = \frac{r}{h}}
$$

Applico la formula:

$$
\textcolor{blue}{V = \pi \int_{a}^{b} [f(x)]^2 dx = \pi \int_{0}^{h} \frac{r^2}{h^2} x^2 dx = \pi \left[ \frac{r^2}{h^2} \frac{x^3}{3} \right]_{0}^{h} =}
$$

$$
\textcolor{blue}{= \pi \frac{r^2}{h^2} \frac{h^3}{3} - \pi \frac{r^2}{h^2} \frac{0^3}{3} = \textcolor{red}{\pi \frac{r^2 h}{3}}}
$$