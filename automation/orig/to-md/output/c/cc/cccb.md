...
$$
\textcolor{red}{y = \sqrt{x-3}}
$$

Poiché la radice è definita solo per valori non negativi del radicando, il termine sotto radice dovrà essere maggiore o uguale a zero

$$
\textcolor{red}{(x-3) \geq 0}
$$

segue

$$
\textcolor{red}{x \geq 3}
$$
