...
$$
\textcolor{blue}{F(x, y(x), y'(x), y''(x), \dots, y^N(x)) = 0}
$$

> L'ordine è dato dall'ordine più alto delle derivate che sono coinvolte.

Noi studieremo alcune equazioni differenziali ordinarie di primo ordine, cioè con le incognite $$\textcolor{red}{x, y(x), y'(x)}$$.
