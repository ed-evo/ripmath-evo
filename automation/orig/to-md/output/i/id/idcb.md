...
$$
\textcolor{red}{\cos \alpha = \frac{OH}{OP}}
$$
...
$$
\textcolor{red}{\cos \beta = \frac{OH}{OP}}
$$
...
> [**In ogni triangolo rettangolo un cateto è uguale al prodotto dell'ipotenusa per il coseno dell'angolo adiacente al cateto considerato**]{.text-blue}
>
> $$
> \textcolor{red}{b = c \cos \alpha}
> $$
