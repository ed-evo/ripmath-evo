...
> Quindi per la nuova struttura di campo basterà aggiungere che la seconda operazione (moltiplicazione) è commutativa

Si definisce **Campo** $(K ; \oplus, \otimes)$ un insieme di enti tali che

1. $(K ; \oplus, \otimes)$ è un [corpo](hcfa.html)
2. l'operazione $\otimes$ è commutativa, cioè per ogni coppia di elementi $a$ e $b$ di $K$ vale la relazione 
