...
a. Numeri naturali
    a. Generalità sui numeri naturali
    b. I numeri naturali
    c. Concetto di operazione interna
...
c. Numeri razionali
    ...
    f. Prodotto fra numeri razionali
    g. Quoziente fra numeri razionali
    h. Potenza intera di numeri razionali
    i. Espressioni con numeri razionali
        a. scomposizione di un numero in fattori primi
        ...
        c. applicazione alla somma e differenza fra numeri razionali (m.c.m.)
...
d. Numeri reali
    ...
    f. Quoziente fra numeri reali
    g. Elevamento a potenza
        a. esponente intero
...
e. Numeri immaginari e complessi
    ...
    b. Numeri complessi
        ...
        b. operazioni sui numeri complessi
            ...
            c. Prodotto
            d. Quoziente
            e. [Espressioni]{.text-red}
        c. il piano complesso
            a. il piano complesso
            b. forma trigonometrica dei numeri complessi
                a. Trasformare un numero complesso dalla forma normale alla forma trigonometrica
                b. Trasformare un numero complesso dalla forma trigonometrica alla forma normale
            c. Prodotto di numeri complessi sotto forma trigonometrica
                a. Dimostrazione
    ...
    d. Il sistema di coordinate polari
        ...
        c. Trasformazione da coordinate cartesiane ortogonali a coordinate polari
        d. Sistema di coordinate polari nello spazio
    e. Forma esponenziale dei numeri complessi
        a. Funzione esponenziale con esponente immaginario
        b. Formule di Eulero
        c. Funzione esponenziale con esponente complesso
f. Teorie formali
    a. Assetto formale di una teoria matematica
        a. L'astrazione
        b. Utilizzo di simboli specifici
        c. Postulati iniziali
    ...
    b. L'aritmetica come sistema formale
        ...
        d. Numeri di Gödel
        e. Importanza della codifica di Gödel
        f. Aritmetica come esempio di sistema formale
    c. Brevi cenni sui limiti della formalizzazione
        a. Il paradosso del mentitore
        b. Antinomia di Russel
        c. Crisi dei fondamenti
        d. Teorema di Gödel
        e. Conclusioni
g. Principi di stenaritmia
    a. introduzione
    b. addizione
    c. sottrazione
    d. moltiplicazione
