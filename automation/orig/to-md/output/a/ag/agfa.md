...
$\textcolor{blue}{x^4 - 5x^3 + 5x^2 + 5x - 6 =}$
...
quindi $(x-1)$ è un fattore: divido per $(x-1)$
...
$\textcolor{blue}{(x-1), \quad P(1) = 1^3 - 4 \cdot 1^2 + 1 - 6 = 1 - 4 + 1 + 6 \neq 0}$
...
Un metodo vale l'altro: per scomporre l'ultimo termine posso applicare la scomposizione del [trinomio notevole](../ad/ad6e.html), cioè
