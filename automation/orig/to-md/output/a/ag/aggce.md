...
Significa che nell'intervallo $x > 2$ il termine entro il modulo è positivo quindi metto $x-2$ al posto del modulo; invece nell'intervallo $x < 2$ il termine entro il modulo è negativo quindi cambio di segno e metto $-x+2$ al posto del modulo. La mia disequazione diventa
...
$$
\begin{cases} -2 \ge -x + 8 \\ x < 2 \\ x < -2 \end{cases} \quad \begin{cases} 2x + 2 \ge -x + 8 \\ x < 2 \\ x \ge -2 \end{cases} \quad \textcolor{green}{\begin{cases} -2x + 2 \ge -x + 8 \\ x \ge 2 \\ x < 2/3 \end{cases}} \quad \textcolor{blue}{\begin{cases} 4x - 2 \ge -x + 8 \\ x \ge 2 \\ x \ge 2/3 \end{cases}}
$$
...
$$
\begin{cases} -2 \ge -x + 8 \\ x < 2 \\ x < -2 \end{cases} \implies \begin{cases} x \ge 2 + 8 \\ x < 2 \\ x < -2 \end{cases} \implies \begin{cases} x \ge 10 \\ x < 2 \\ x < -2 \end{cases}
$$
...
$$
\textcolor{magenta}{\begin{cases} 2x + 2 \ge -x + 8 \\ x < 2 \\ x \ge -2 \end{cases} \implies \begin{cases} 2x + x \ge -2 + 8 \\ x < 2 \\ x \ge -2 \end{cases} \implies \begin{cases} 3x \ge 6 \\ x < 2 \\ x \ge -2 \end{cases} \implies \begin{cases} x \ge 2 \\ x < 2 \\ x \ge -2 \end{cases}}
$$
...
$$
\textcolor{green}{\begin{cases} -2x + 2 \ge -x + 8 \\ x \ge 2 \\ x < 2/3 \end{cases} \implies \begin{cases} -2x + x \ge -2 + 8 \\ x \ge 2 \\ x < 2/3 \end{cases} \implies \begin{cases} -x \ge 6 \\ x \ge 2 \\ x < 2/3 \end{cases} \implies \begin{cases} x \le -6 \\ x \ge 2 \\ x < 2/3 \end{cases}}
$$
...
$$
\textcolor{blue}{\begin{cases} 4x - 2 \ge -x + 8 \\ x \ge 2 \\ x \ge 2/3 \end{cases} \implies \begin{cases} 4x + x \ge 2 + 8 \\ x \ge 2 \\ x \ge 2/3 \end{cases} \implies \begin{cases} 5x \ge 10 \\ x \ge 2 \\ x \ge 2/3 \end{cases} \implies \begin{cases} x \ge 2 \\ x \ge 2 \\ x \ge 2/3 \end{cases}}
$$
...
> Il simbolo $/$ significa "tale che". Si legge: per ogni numero Reale $x$ tale che $x$ appartenga all'intervallo semiaperto da $2$ a $+$ infinito: semiaperto significa che $+\infty$ non è compreso ma $2$ è compreso quindi appartiene alle soluzioni.
