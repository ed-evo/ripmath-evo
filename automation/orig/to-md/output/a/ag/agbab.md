...
oppure in modo equivalente (preferibilmente lungo la retta reale si cerca sempre di andare da sinistra verso destra cioè scrivo prima i valori più piccoli poi il segno minore e infine i valori più grandi)

$$
\textcolor{red}{-5 < -2}
$$

> [Se moltiplico o divido per un numero negativo devo cambiare di verso la disequazione]{.text-blue}