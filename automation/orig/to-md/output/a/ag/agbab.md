...
oppure in modo equivalente ([preferibilmente](agbaba.html) lungo la retta reale si cerca sempre di andare da sinistra verso destra cioè scrivo prima i valori più piccoli poi il segno minore e infine i valori più grandi)

$$
-5 < -2
$$

> <span class="text-blue-900">Se moltiplico o divido per un numero negativo devo cambiare di verso la disequazione</span>