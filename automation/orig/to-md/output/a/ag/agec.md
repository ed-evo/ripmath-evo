# <span class="text-red-600">Applicazioni a disequazioni prodotto di espressioni di primo e secondo grado</span>
...
Se hai bisogno di vedere un altro [esempio](ageca.html).
