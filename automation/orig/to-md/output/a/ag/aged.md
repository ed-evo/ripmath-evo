# <span class="text-red-600">Applicazioni a disequazioni quoziente di espressioni di primo e secondo grado</span>
...
$$
\textcolor{blue}{\begin{cases} x - 3 > 0 \\ x^2 - 6x + 5 > 0 \end{cases}}
$$
...
$$
\textcolor{blue}{\begin{cases} x > 3 \\ x < 1 \cup x > 5 \end{cases}}
$$
...
$\textcolor{blue}{\frac{x^2 - 9}{x - 2} \ge 0}$ [svolgimento](ageda.html)

$\textcolor{blue}{\frac{x^2 - 3x + 2}{x - 5} \le 0}$ [svolgimento](agedb.html)

---

Importante è anche il seguente caso particolare: quando il numeratore ed il denominatore sono fra loro semplificabili:

$\textcolor{blue}{\frac{x^2 - 5x + 6}{x - 3} > 0}$ [svolgimento](agedc.html)
