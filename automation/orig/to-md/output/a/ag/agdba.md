...
> Quando $a$ è minore di zero potremmo cambiare di segno tutti i termini del trinomio (cambiando anche di verso la disequazione), ma il metodo della parabola è talmente semplice che di solito si preferisce applicarlo senza cambiare di segno
