...
$$
\textcolor{red}{\log_{1/3}(3-x) > \log_{1/3}(2x+6)}
$$
...
$$
\textcolor{blue}{\log_{1/3}(\text{espressione}) > 0}
$$

Porto tutti i termini prima del maggiore

$$
\textcolor{blue}{\log_{1/3}(3 - x) - \log_{1/3}(2x+6) > 0}
$$
...
$$
\textcolor{blue}{\begin{cases} \frac{3-x}{2x+6} > 0 \\ \frac{3-x}{2x+6} < 1 \end{cases}}
$$
...
$$
\textcolor{blue}{\begin{cases} x < 3 \\ x > -3 \\ -1 < x < 3 \end{cases}}
$$

Riporto i dati su un grafico, e prendo i valori comuni a tutte le disequazioni

> **Nota:** indico i valori accettabili con una linea continua
