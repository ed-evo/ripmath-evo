...
$$
\begin{vmatrix}
\textcolor{blue}{a_{1,1}} & \textcolor{blue}{a_{1,2}} \\
\textcolor{blue}{a_{2,1}} & a_{2,2}
\end{vmatrix}
$$

devo eliminare la riga e la colonna dove si trova [$$\textcolor{red}{a_{1,1}}$]{.text-red}, cioè gli elementi in blu e quindi mi resta
