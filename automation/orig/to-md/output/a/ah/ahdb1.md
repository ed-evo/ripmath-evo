...
Pongo:
$$
\textcolor{red}{AB = x} \quad \textcolor{red}{BC = x + 11}
$$

Sostituisco nella relazione dell'area ed ottengo l'equazione risolvente:
$$
\textcolor{red}{(x + 11) \cdot x = 80}
$$
$$
\textcolor{red}{x^2 + 11x = 80}
$$
$$
\textcolor{red}{x^2 + 11x - 80 = 0}
$$
...
$$
$$
\textcolor{blue}{AB = 5 \text{ cm}}
$$
$$
\textcolor{blue}{BC = x + 11 = 16 \text{ cm}}
$$
