...
Questa definizione deriva dal fatto che la distanza (che è sempre positiva) in geometria euclidea viene definita come radice quadrata della somma dei quadrati delle coordinate, cioè:

$$
\textcolor{red}{\sqrt{(x^2 + y^2 + z^2)} = \text{distanza}}
$$

Applicando il concetto su uno spazio ad una dimensione (retta) viene fuori il concetto di modulo:

$$
\textcolor{red}{| \text{distanza} | = \sqrt{(x^2)}}
$$