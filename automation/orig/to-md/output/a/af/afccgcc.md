...
È preferibile usare la formula ridotta piuttosto che la formula completa, anche perché, come potrai vedere confrontando i metodi, con la formula ridotta le operazioni vengono, di solito, semplificate.
...
$$
\textcolor{blue}{x_{1,2} = \frac{+6 \pm \sqrt{6^2 - 4(5)(5)}}{2(5)}}
$$

Facciamo i calcoli dentro la radice:

$$
\textcolor{blue}{= \frac{6 \pm \sqrt{36 - 100}}{10}}
$$

$$
\textcolor{blue}{= \frac{+6 \pm \sqrt{-64}}{10}}
$$
...
> - se invece hai fatto i [numeri complessi](../../b/be/be.html) puoi procedere e trovare le soluzioni complesse
...
$$
\textcolor{red}{x_1 = \frac{3 + 4i}{5}, \quad x_2 = \frac{3 - 4i}{5}}
$$

Essendo il [discriminante](afccc.html) dell'equazione minore di zero abbiamo due soluzioni complesse e coniugate.
...
$$
\textcolor{blue}{x_{1,2} = \frac{+3 \pm \sqrt{3^2 - (5)(5)}}{5}}
$$

Facciamo i calcoli dentro la radice:

$$
\textcolor{blue}{= \frac{3 \pm \sqrt{9 - 25}}{5}}
$$

$$
\textcolor{blue}{= \frac{3 \pm \sqrt{-16}}{5}}
$$
