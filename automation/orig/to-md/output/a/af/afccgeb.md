...
$$
\begin{aligned}
\textcolor{blue}{s} &= \textcolor{blue}{x_1 + x_2 = 1} \\
\textcolor{blue}{p} &= \textcolor{blue}{x_1 \cdot x_2 = -6}
\end{aligned}
$$
...
$$
\textcolor{blue}{= \frac{1 \pm \sqrt{1 + 24}}{2} =}
$$
$$
\textcolor{blue}{= \frac{1 \pm \sqrt{25}}{2} =}
$$
$$
\textcolor{blue}{= \frac{1 \pm 5}{2} =}
$$
