...
$$
\begin{cases} \textcolor{red}{x + 2 \ge 0} \\ \textcolor{red}{-x - 2 \ge 0} \end{cases}
$$

Cambio di segno e di verso la seconda

$$
\begin{cases} \textcolor{red}{x + 2 \ge 0} \\ \textcolor{red}{x + 2 \le 0} \end{cases}
$$

Risolvo

$$
\begin{cases} \textcolor{red}{x \ge -2} \\ \textcolor{red}{x \le -2} \end{cases}
$$
