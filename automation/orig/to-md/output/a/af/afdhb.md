...
$$
\textcolor{blue}{x_{1,2} = \frac{-(-2) \pm \sqrt{(-2)^2 - (1)(12)}}{1} =}
$$

Facciamo i calcoli dentro la radice:

$$
\textcolor{blue}{= 2 \pm \sqrt{4 - 12} =}
$$

$$
\textcolor{blue}{= 2 \pm \sqrt{-8} =}
$$

Essendo negativo il termine dentro la radice, otterrò due radici complesse e coniugate.
...
$x_1 = 2 - 2i\sqrt{2} \quad x_2 = 2 + 2i\sqrt{2}$