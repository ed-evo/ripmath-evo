# <span class="text-red-600">METODO DI TARTAGLIA PER CALCOLARE LA POTENZA DI UN BINOMIO</span>
...
Possiamo subito osservare che tutti i risultati sono [polinomi ordinati](ad1c.html) secondo la potenza decrescente della lettera $a$ e secondo la potenza crescente della lettera $b$, sono anche [completi](ad1d.html) ed infine la potenza del primo termine corrisponde alla potenza del binomio; quindi se devo calcolare
...
> (Fai click [qui](ad4cfa1.html) se hai bisogno di ulteriori spiegazioni)
...
al posto di $a$ ho $2x$ ed al posto di $b$ ho $3y$, quindi vado a sostituire:
...
> se hai bisogno di vedere i calcoli fai click [qui](ad4cfa3.html)

***

Fai i seguenti esercizi poi confronta con quelli che ho sviluppato io:

- $(x-2y)^4 = \text{[soluzione](ad4cfa4.html)}$
- $(2x+y)^5 = \text{[soluzione](ad4cfa5.html)}$
- $(3x-y)^5 = \text{[soluzione](ad4cfa6.html)}$
- $(2a^2-3b)^5 = \text{[soluzione](ad4cfa7.html)}$
- $(x-2y)^6 = \text{[soluzione](ad4cfa8.html)}$
- $(2x^2+y^3)^6 = \text{[soluzione](ad4cfa9.html)}$

***

[esercizi sulla potenza intera del binomio](../../../cdrom/cd/a0/ab/abc/abce.html)