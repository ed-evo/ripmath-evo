...
- Se tutti gli elementi di una riga (di una colonna) sono nulli allora il determinante vale $$0$$
- Scambiando fra loro due righe (due colonne) il determinante cambia di segno
- Se in un determinante due righe (due colonne) sono proporzionali il determinante vale $$0$$
...
- Se gli elementi di una riga (colonna) sono somma di due addendi allora il determinante è uguale alla somma dei determinanti che hanno nella riga (colonna) come elementi il primo addendo ed il secondo addendo
