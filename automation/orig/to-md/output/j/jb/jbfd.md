...
Si indica come $\textcolor{red}{A \setminus B}$ od anche $\textcolor{red}{A-B}$
si legge differenza fra $A$ e $B$

Abbiamo due casi:

- il secondo insieme non è contenuto completamente nel primo insieme;
  ...
  > l'insieme differenza è in azzurro

- il secondo insieme è contenuto nel primo insieme $\textcolor{red}{B \subseteq A}$;
