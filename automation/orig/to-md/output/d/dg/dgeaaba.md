...
$$
V = \left( -\frac{6}{2 \cdot (-1)}, -\frac{6^2 - 4 \cdot (-1) \cdot 0}{4 \cdot (-1)} \right)
$$

$$
V = \left( -\frac{6}{-2}, -\frac{36}{-4} \right)
$$
...
$$
\begin{cases} y = 0 \\ y = -x^2 + 6x \end{cases}
$$

$$
\begin{cases} y = 0 \\ -x^2 + 6x = 0 \end{cases}
$$
...
$$
\begin{cases} y = 0 \\ x(x-6) = 0 \end{cases}
$$
...
$$
\begin{cases} x = 0 \\ y = -x^2 + 6x \end{cases}
$$
...
quindi il punto di intersezione con l'asse delle $y$ è l'origine
