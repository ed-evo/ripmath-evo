Qui è molto più comprensibile: la relazione corrisponde all'equivalenza fra frazioni: infatti se, ad esempio abbiamo

$$
\textcolor{red}{\frac{2}{3} = \frac{4}{6}}
$$
segue che vale
$$
\textcolor{red}{2 \cdot 6 = 4 \cdot 3}
$$

In formule

$$
\textcolor{red}{\frac{a}{b} = \frac{c}{d}}
$$
segue che vale
$$
