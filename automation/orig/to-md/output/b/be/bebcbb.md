...
$$
\textcolor{blue}{\tan \Theta = \frac{b}{a}}
$$

o meglio, trasformiamole in:

$$
\textcolor{blue}{a^2+b^2 = \rho^2}
$$
...
Considero il numero complesso in forma trigonometrica:

$$
\textcolor{blue}{z = \sqrt{2} \left( \cos \frac{\pi}{4} + i \sin \frac{\pi}{4} \right)}
$$
...
$$
\textcolor{blue}{\begin{cases} a^2 + b^2 = \rho^2 \\ b = a \tan \Theta \end{cases}}
$$
...
$$
\textcolor{blue}{z = 2\sqrt{3} \left( \cos \frac{\pi}{6} + i \sin \frac{\pi}{6} \right)}
$$
...
$$
\textcolor{red}{\begin{cases} a^2 + b^2 = 12 \\ b = a \frac{\sqrt{3}}{3} \end{cases}}
$$

o, meglio:

$$
\textcolor{red}{\begin{cases} a^2 + b^2 = 12 \\ a = b\sqrt{3} \end{cases}}
$$
